...
Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If StrComp("yes", done) = 0 Then
            ...
            Else
                ...
                Process.Start(Application.StartupPath + "\mm_popup.exe")
                End
            End If
        End If
        timer.Start()
    ...
    Private Sub timer_Elapsed(ByVal sender As System.Object, ByVal e As System.Timers.ElapsedEventArgs) Handles timer.Elapsed
        ...
        If StrComp("yes", done) = 0 Then
            ...
            Else
                ...
                iniFile.SetKeyValue("User", "NeedsAlerted", "no")
                iniFile.Save(Application.StartupPath + "\monkmode_settings.ini")
                Dim killHelper As Process() = Process.GetProcessesByName("mm_notify2")
                Dim proc As Process
                Try
    ...
    Private Sub timerHelper_Elapsed(ByVal sender As System.Object, ByVal e As System.Timers.ElapsedEventArgs) Handles timerHelper.Elapsed
        Dim helperProcessList = System.Diagnostics.Process.GetProcessesByName("mm_notify2")
        Try
            ...
            If Proc.SessionId <> 0 Then
                Try
                    If iniProcessList.Contains(Proc.ProcessName + ".exe") Then
                        Proc.Kill()
                        MsgBox("MonkMode just closed a blocked program from running." + vbNewLine + "Get back to work!", MsgBoxStyle.Exclamation, "Haha, nice try!")
                    End If
                Catch ex As Exception
                End Try
            End If
