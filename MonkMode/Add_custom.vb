...
Public Class Add_custom
    ...
    Private Sub addbox_done_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles addbox_done.Click
        ...
        If anythingAdded = True Then
            ...
            End Using
            Me.Hide()
            MsgBox("Good Job! New sites were added." + vbNewLine + "You might need to restart your browser windows to see the block take effect", MsgBoxStyle.OkOnly, "MonkMode")
        Else
            Me.Hide()
            MsgBox("No new items added... Wuss.", MsgBoxStyle.OkOnly, "MonkMode")
        End If
