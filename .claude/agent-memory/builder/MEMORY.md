...
- [Scripted file edits corrupt sources](powershell-setcontent-corrupts-vb-sources.md) — PowerShell Set-Content adds a BOM, Python round-trip flattens CRLF→LF; use the Edit tool or Copy-Item
